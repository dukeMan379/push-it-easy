Feature: New Customer
  ...
  Background: User should be on demo site and logged in
  ...
  Scenario: NC5 Verify Address Field (Address can not be empty)  //do I have to create new method again
  ...
  Scenario Outline: NC9 Verify City Field (City cannot be numeric)
